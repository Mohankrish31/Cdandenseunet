...
train_dataset = cvccolondbsplitDataset(train_enhanced_dir, train_high_dir, transform=transform)
val_dataset = cvccolondbsplitDataset(val_enhanced_dir, val_high_dir, transform=transform)
# === Create DataLoaders ===
batch_size = 8
