...
def simulate_endoscopic_degradation(image_rgb, brightness_range=(0.4, 0.7),
    ...
    # 2. Brightness scaling (stronger darkening)
...
def prepare_dataset(input_dir, output_dir, val_ratio=0.1, test_ratio=0.2):
    ...
    """
    print(f"The input directory being used is: {input_dir}")
    ...
    for split, filenames in splits.items():
        ...
        for fname in tqdm(filenames):
            ...
            # keep original size, just convert to RGB
