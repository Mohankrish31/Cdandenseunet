...
def total_loss_fn(pred, target, w_mse, w_lpips, w_edge, w_ssim, w_range, lpips_model):
    ...
    edge  = SobelEdgeLoss()(pred, target)
...
def main():
    ...
    train_dataset = CVCCColonDBDataset(train_enhanced_dir, train_high_dir, transform)
    val_dataset   = CVCCColonDBDataset(val_enhanced_dir, val_high_dir, transform)
